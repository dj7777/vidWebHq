...
<html lang="en">
    <head>
        <title>Install VideoWebsite</title>
                        ...
                        if (checkVideosDir()) {
                            ...
                            <div class="alert alert-danger">
                                ...
                                <details>
                                    ...
                                    if(!file_exists($dir)){
                                    ?>
                                    The video directory does not exists, VideoWebsite had no permition to create it, you must create it manualy!
                                    <br>
                    ...
                    <div class="col-md-6">
                        <form id="configurationForm">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="webSiteTitle" placeholder="Enter the title of your Web Site" value="VideoWebsite" required="required">
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="databaseName" placeholder="Enter Database Name" value="VideoWebsite" required="required">
                            </div>
                            <div class="form-group">
