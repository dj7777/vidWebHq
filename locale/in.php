...
$t['Update Now'] = "VideoWebsite सिस्टम अपडेट करें";
$t['Update the site configuration'] = "नया संस्करण";
$t['Update version'] = "अपने उपयोगकर्ता को अपडेट करें";
$t['Update VideoWebsite System'] = "साइट कॉन्फ़िगरेशन अपडेट करें";
...
$t['Yes, delete it!'] = "आप VideoWebsite संस्करण %s चला रहे हैं!";
$t['You are running VideoWebsite version %s!'] = "आप प्रबंधक श्रेणियां नहीं कर सकते";
