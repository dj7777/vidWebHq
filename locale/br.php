...
$t['<p>VideoWebsite! is an video-sharing website, The service was created by Daniel Neto in march 2017. </p><p>The software allow you to upload, view, share and comment on videos, and it makes use of WebM and H.264/MPEG-4 AVC to display a wide variety of user-generated and corporate media videos. </p><p>Best of all, VideoWebsite! is an open source solution that is freely available to everyone.</p>'] = "<P> VideoWebsite! É um site de partilha de vídeo, O serviço foi criado por Daniel Neto em Março de 2017. O software permite-lhe carregar, ver e comentar em vídeos, e faz uso de WebM e H.264 / MPEG -4 AVC para exibir uma grande variedade de vídeos gerados por usuários e mídia corporativa. </p><p> Melhor de tudo, VideoWebsite! É uma solução open source que está disponível gratuitamente para todos. </p>";
$t['About VideoWebsite!'] = "Sobre o VideoWebsite!";
$t['About'] = "Sobre";
$t['Activate'] = "Ativar";
$t['Active'] = "Ativo";
$t['Admin'] = "Admin";
...
$t['Update VideoWebsite System'] = "Atualizar o sistema VideoWebsite";
...
$t['You are running VideoWebsite version %s!'] = "Você está executando a versão %s do VideoWebsite!";
