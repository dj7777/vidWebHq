...
<html lang="<?php echo $_SESSION['language']; ?>">
    ...
    <body>
        <?php
        include 'include/navbarWithOptions.php';
        ?>
        ...
        <div class="container-fluid gallery" itemscope itemtype="http://schema.org/VideoObject">
            ...
            <div class="col-xs-12 col-sm-9 col-md-9 col-lg-9 list-group-item">
                <?php
                if (!empty($videos)) {
                    ?>
                    <div class="row">
                        ...
                        foreach ($videos as $value) {
                            ...
                            ?>
                            <div class="col-lg-3 col-md-6 col-sm-4 col-xs-6 galleryVideo thumbsImage">
            ...
            <div class="col-xs-12 col-sm-2 col-md-2 col-lg-2">
                    ...
                    <hr>
                    <h3 class="text-danger"><?php echo __("Tags"); ?></h3>
                 <?php
                foreach ($categories as $value) {
                    echo '<button  class="' . ($value['clean_name'] == @$_GET['catName'] ? "active" : "") . ' btn btn-primary">'
                             . '<a style="color:white" href="' . $global['webSiteRootURL'] . 'cat/' . $value['clean_name'] . '" >'
                    . '<span class="' . (empty($value['iconClass']) ? "fa fa-folder" : $value['iconClass']) . '"></span>  ' . $value['name'] . '</a></button>';
                }
                ?>  
            </div>
