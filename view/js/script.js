...
$(document).ready(function () {
    ...
    $('#searchBar').bind('click.search',function(){
        window.open(
            ...
            $('#searchBar').unbind('click.search');
        
    });

    // redirect to ads link on 1st click of videogallery
     $('.container-fluid').bind('click.gallery',function(){
        window.open(
            'https://www.google.com',
            '_blank' // <- This is what makes it open in a new window.
        );
            $('.container-fluid').unbind('click.gallery');
